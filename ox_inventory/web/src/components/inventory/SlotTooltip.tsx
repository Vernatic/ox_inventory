        ...
        <div style={{ ...style }} className="tooltip-wrapper" ref={ref}>
          ...
          {description && (
            <div className="tooltip-description">
              <p className="tooltip-markdown" dangerouslySetInnerHTML={{ __html: description }}></p>
            </div>
          )}
          {inventoryType !== 'crafting' ? (
            <>
              {item?.durability !== undefined && (
                <p>
                  {Locale.ui_durability || 'Durability'}: {Math.trunc(item.durability)}
                </p>
              )}
              {item.metadata?.ammo !== undefined && (
                <p>
                  {Locale.ui_ammo || 'Ammo'}: {item.metadata.ammo}
                </p>
              )}
              {ammoName && (
                <p>
